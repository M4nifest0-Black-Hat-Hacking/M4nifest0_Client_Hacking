...
-📌 Has a dedicated control panel.

-📌 Access to the entire target system.

-📌 Get the target location.

-📌 Get information about the entire target system.

-📌 Listen to the target location environment.

-📌 Execute comment commands.

-📌 Execute pop-up commands.

-📌 Execute commands to extract, download and upload  victim system.

-📌 Get a WiFi connection password.
